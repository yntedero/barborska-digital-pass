<template>
  ...
  >
    ...
    <Transition name="slide-up">
      ...
      >
        <!-- Header -->
        <div class="relative bg-gradient-to-br from-(--color-gold-50) to-(--color-gold-100) dark:from-(--color-gold-950) dark:to-(--color-sand-900) px-6 pt-8 pb-6 text-center">
          <div class="relative">
        ...
        <!-- Content -->
        <div class="px-6 py-5">
          <p class="text-sm text-(--color-sand-600) dark:text-(--color-sand-300) leading-relaxed text-center">
