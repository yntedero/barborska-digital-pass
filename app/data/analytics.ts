...
export const analyticsData: AnalyticsData = {
  ...
  activityFeed: [
    ...
    { id: 3, type: 'checkin', message: 'GPS overený: Banská Štiavnica', time: 'pred 8 min', stopId: 18 },
    { id: 4, type: 'popular', message: 'Špania Dolina — 15 návštev dnes', time: 'pred 12 min', stopId: 3 },
    ...
    { id: 8, type: 'popular', message: 'Kremnica — 28 návštev dnes', time: 'pred 35 min', stopId: 13 },
    ...
    { id: 11, type: 'checkin', message: 'GPS overený: Banská Bystrica', time: 'pred 55 min', stopId: 1 },
    { id: 12, type: 'popular', message: 'Banská Bystrica — 34 návštev dnes', time: 'pred 1 hod', stopId: 1 },
    ...
    { id: 18, type: 'checkin', message: 'GPS overený: Sklené Teplice', time: 'pred 3 hod', stopId: 16 },
    { id: 19, type: 'popular', message: 'Zvolen — 19 návštev dnes', time: 'pred 3 hod', stopId: 24 },
    ...
    { id: 24, type: 'popular', message: 'Staré Hory — 12 návštev dnes', time: 'pred 4 hod', stopId: 5 },
    ...
    { id: 30, type: 'popular', message: 'Banská Štiavnica — 22 návštev dnes', time: 'pred 6 hod', stopId: 18 },
    ...
    { id: 37, type: 'checkin', message: 'GPS overený: Kláštor Sampor', time: 'pred 8 hod', stopId: 27 },
    ...
    { id: 41, type: 'popular', message: 'Kremnica — 31 návštev včera', time: 'pred 10 hod', stopId: 13 },
    { id: 42, type: 'checkin', message: 'Check-in: Kremnické Bane', time: 'pred 10 hod', stopId: 12 },
    ...
    { id: 45, type: 'checkin', message: 'Check-in: Šášovské Podhradie', time: 'pred 11 hod', stopId: 15 },
    { id: 46, type: 'visitor', message: 'Nový návštevník zo Slovenska', time: 'pred 12 hod' },
    { id: 47, type: 'popular', message: 'Ostrá Lúka — 6 návštev včera', time: 'pred 12 hod', stopId: 23 },
    { id: 48, type: 'checkin', message: 'GPS overený: Banský Studenec', time: 'pred 13 hod', stopId: 21 },
    { id: 49, type: 'checkin', message: 'Check-in: Banskoštiavnická kalvária', time: 'pred 14 hod', stopId: 19 },
